#### Master Script 10c: Calculate ORC in bootstrapping resamples to determine dropout configurations ####
#
...
repeat_dir = os.path.join('/home/sb2406/rds/hpc-work/APM_outputs/'+VERSION,'repeat'+str(REPEAT).zfill(int(np.log10(cv_splits.repeat.max()))+1))
