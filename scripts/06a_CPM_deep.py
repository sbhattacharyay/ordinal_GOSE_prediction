...
# III. Train CPM_deep model based on provided hyperparameter row index
...
def main(array_task_id):
    ...
    training_set = pd.read_csv('/home/sb2406/rds/hpc-work/imputed_CPM_sets/repeat'+str(curr_repeat).zfill(2)+'/fold'+str(curr_fold)+'/training_set.csv')
    testing_set = pd.read_csv('/home/sb2406/rds/hpc-work/imputed_CPM_sets/repeat'+str(curr_repeat).zfill(2)+'/fold'+str(curr_fold)+'/testing_set.csv')
